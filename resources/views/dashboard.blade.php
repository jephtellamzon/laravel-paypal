<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 grid-row-5 gap-4">
                {{-- Product1 --}}
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <a href="#">
                            <img class="rounded-t-lg" src="{{ asset('images/mouse.jpg') }}" alt="" />
                        </a>
                        <div class="p-5">
                            <a href="#">
                                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Mouse</h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">$20.00</p>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <a href="#">
                            <img class="rounded-t-lg" src="{{ asset('images/monitor.jpg') }}" alt="" />
                        </a>
                        <div class="p-5">
                            <a href="#">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <a href="#">
                            <img class="rounded-t-lg" src="{{ asset('images/keyboard.jpg') }}" alt="" />
                        </a>
                        <div class="p-5">
                            <a href="#">
